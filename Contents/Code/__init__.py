# Moviepilot metadata agent for Plex - www.moviepilot.de
	...
	def update(self, metadata, media, lang):
		...
		if lang == Locale.Language.German:
			try:
				...
				try:
					movie = HTML.ElementFromURL(INFO_BY_IMDB % (metadata.id), sleep=3.0, cacheTime=CACHE_1DAY*365, headers={'User-Agent':'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:18.0) Gecko/20100101 Firefox/18.0'})
